...
public static class DependencyInjectionExtensions
{
    ...
    private static void TypeToInstanceFuncRegister(IServiceCollection services, DependencyProxyDescriptor d)
    {
        ...
        {
            case ServiceLifetime.Scoped:
                services.AddScoped(d.ServiceType, _ => d.InstanceFuncForImplementation());
                break;

            case ServiceLifetime.Singleton:
                services.AddSingleton(d.ServiceType, _ => d.InstanceFuncForImplementation());
                break;

            case ServiceLifetime.Transient:
                services.AddTransient(d.ServiceType, _ => d.InstanceFuncForImplementation());
                break;
    ...
    private static void InstanceSelfFuncRegister(IServiceCollection services, DependencyProxyDescriptor d)
    {
        ...
        {
            case ServiceLifetime.Scoped:
                services.AddScoped(_ => d.InstanceFuncForImplementation());
                break;

            case ServiceLifetime.Singleton:
                services.AddSingleton(_ => d.InstanceFuncForImplementation());
                break;

            case ServiceLifetime.Transient:
                services.AddTransient(_ => d.InstanceFuncForImplementation());
                break;
